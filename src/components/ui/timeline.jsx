  ...
  return (
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis, placeat distinctio minus soluta quidem, eum qui obcaecati, sit porro inventore architecto ex neque maxime quas impedit error eveniet tenetur itaque.
        </p>
      </div>
