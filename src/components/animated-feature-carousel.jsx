...
function FeatureCard({
  ...
  return (
    <motion.div
      ...
      <div
        className="relative w-full overflow-hidden rounded-3xl border border-neutral-200 bg-white transition-colors duration-300 dark:border-neutral-800 dark:bg-neutral-900">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              <motion.div
                ...
                <p
                  className="text-base leading-relaxed text-neutral-700 dark:text-neutral-400">
