    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto text-center relative">
          ...
          <Link to="https://captcha.rbg.ai:8001">

            <button className="inline-flex justify-center items-center px-8 py-3 rounded-lg border-2 border-blue-600 text-blue-600 font-semibold hover:bg-blue-100 transition-colors duration-200 shadow-lg hover:shadow-xl">
            Get Started with Captcha
