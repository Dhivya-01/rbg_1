...
export function Proof() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-rose-25 via-white to-rose-50 relative overflow-hidden">
      
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 right-10 w-96 h-96 bg-rose-100 rounded-full blur-3xl opacity-30 animate-pulse"></div>
        <div className="absolute bottom-1/3 left-10 w-80 h-80 bg-rose-200 rounded-full blur-3xl opacity-20 animate-pulse animation-delay-4000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {stats.map((stat, idx) => (
            <div
              key={idx}
              data-index={idx}
              className={`stat-item animated-item text-center p-8 bg-white/80 backdrop-blur-sm rounded-2xl border border-rose-100/50 hover:shadow-xl transition-all duration-500 hover:scale-105 ${
            ...
            >
              ...
              <div className="text-lg font-semibold text-rose-600 mb-2">{stat.label}</div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 md:p-12 shadow-xl border border-rose-100/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {benefits.map((benefit, idx) => (
                <div
                  key={idx}
                  data-index={idx + 10}
                  className={`animated-item flex items-start gap-4 p-6 bg-gradient-to-br from-rose-50/50 to-rose-100/50 rounded-2xl border border-rose-100/30 hover:shadow-lg transition-all duration-500 ${
                ...
                >
                  <div className="w-12 h-12 bg-gradient-to-r from-rose-400 to-rose-500 rounded-xl flex items-center justify-center text-xl flex-shrink-0">
                    {benefit.icon}
                  </div>
                  <div>
            ...
            <div className="text-center mt-12 pt-8 border-t border-rose-100">
              <button className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-rose-400 to-rose-500 text-white rounded-full hover:from-rose-500 hover:to-rose-600 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl font-semibold text-lg">
